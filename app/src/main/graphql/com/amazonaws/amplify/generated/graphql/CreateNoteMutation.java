...
public final class CreateNoteMutation implements Mutation<CreateNoteMutation.Data, CreateNoteMutation.Data, CreateNoteMutation.Variables> {
  public static final String OPERATION_DEFINITION = "mutation CreateNote($input: CreateNoteInput!, $condition: ModelNoteConditionInput) {\n"
  ...
  public CreateNoteMutation(@Nonnull CreateNoteInput input,
      @Nullable ModelNoteConditionInput condition) {
    Utils.checkNotNull(input, "input == null");
    variables = new CreateNoteMutation.Variables(input, condition);
  }

  @Override
  public String operationId() {
    return "1d5f4ad54c157164661f22f98f51bef881939b1791ace49aa6172c9b7aab366f";
  }
  ...
  public static final class Builder {
    private @Nonnull CreateNoteInput input;
    ...
    public Builder input(@Nonnull CreateNoteInput input) {
      this.input = input;
      return this;
    }
    ...
    public CreateNoteMutation build() {
      Utils.checkNotNull(input, "input == null");
      return new CreateNoteMutation(input, condition);
    }
  }

  public static final class Variables extends Operation.Variables {
    private final @Nonnull CreateNoteInput input;

    private final @Nullable ModelNoteConditionInput condition;

    private final transient Map<String, Object> valueMap = new LinkedHashMap<>();

    Variables(@Nonnull CreateNoteInput input, @Nullable ModelNoteConditionInput condition) {
      this.input = input;
      this.condition = condition;
    ...
    public @Nonnull CreateNoteInput input() {
      return input;
    }
  ...
  public static class Data implements Operation.Data {
    static final ResponseField[] $responseFields = {
      ResponseField.forObject("createNote", "createNote", new UnmodifiableMapBuilder<String, Object>(2)
    ...
    final @Nullable CreateNote createNote;
    ...
    public Data(@Nullable CreateNote createNote) {
      this.createNote = createNote;
    }

    public @Nullable CreateNote createNote() {
    ...
    public ResponseFieldMarshaller marshaller() {
      return new ResponseFieldMarshaller() {
        ...
        public void marshal(ResponseWriter writer) {
          writer.writeObject($responseFields[0], createNote != null ? createNote.marshaller() : null);
        }
      };
    }
    ...
    public boolean equals(Object o) {
      ...
      if (o instanceof Data) {
        Data that = (Data) o;
        return ((this.createNote == null) ? (that.createNote == null) : this.createNote.equals(that.createNote));
      }
      return false;
    }
    ...
    public int hashCode() {
      if (!$hashCodeMemoized) {
        int h = 1;
        h *= 1000003;
        h ^= (createNote == null) ? 0 : createNote.hashCode();
        $hashCode = h;
  ...
  public static class CreateNote {
    ...
    public CreateNote(@Nonnull String __typename, @Nonnull String id, @Nonnull String title,
    ...
    public static final class Mapper implements ResponseFieldMapper<CreateNote> {
      ...
      public CreateNote map(ResponseReader reader) {
        ...
        return new CreateNote(__typename, id, title, content, blabla, _version, _deleted, _lastChangedAt, owner);
      }
    }
  }
}
