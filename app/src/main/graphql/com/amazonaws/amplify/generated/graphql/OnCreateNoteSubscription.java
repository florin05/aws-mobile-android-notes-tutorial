...
public final class OnCreateNoteSubscription implements Subscription<OnCreateNoteSubscription.Data, OnCreateNoteSubscription.Data, OnCreateNoteSubscription.Variables> {
  public static final String OPERATION_DEFINITION = "subscription OnCreateNote($owner: String!) {\n"
  ...
  private final OnCreateNoteSubscription.Variables variables;

  public OnCreateNoteSubscription(@Nonnull String owner) {
    Utils.checkNotNull(owner, "owner == null");
    variables = new OnCreateNoteSubscription.Variables(owner);
  }

  @Override
  public String operationId() {
    return "500f1361b59bb53a3db71181f57768b8e4d7f5f0646c9f759c3419b92634fa62";
  }
  ...
  @Override
  public OnCreateNoteSubscription.Data wrapData(OnCreateNoteSubscription.Data data) {
    return data;
  }

  @Override
  public OnCreateNoteSubscription.Variables variables() {
    return variables;
  }

  @Override
  public ResponseFieldMapper<OnCreateNoteSubscription.Data> responseFieldMapper() {
  ...
  public static final class Builder {
    ...
    public OnCreateNoteSubscription build() {
      Utils.checkNotNull(owner, "owner == null");
      return new OnCreateNoteSubscription(owner);
    }
  }
  ...
  public static class Data implements Operation.Data {
    static final ResponseField[] $responseFields = {
      ResponseField.forObject("onCreateNote", "onCreateNote", new UnmodifiableMapBuilder<String, Object>(1)
    ...
    final @Nullable OnCreateNote onCreateNote;
    ...
    public Data(@Nullable OnCreateNote onCreateNote) {
      this.onCreateNote = onCreateNote;
    }

    public @Nullable OnCreateNote onCreateNote() {
      return this.onCreateNote;
    }
    ...
    public ResponseFieldMarshaller marshaller() {
      return new ResponseFieldMarshaller() {
        ...
        public void marshal(ResponseWriter writer) {
          writer.writeObject($responseFields[0], onCreateNote != null ? onCreateNote.marshaller() : null);
        }
      };
    }
    ...
    public boolean equals(Object o) {
      ...
      if (o instanceof Data) {
        Data that = (Data) o;
        return ((this.onCreateNote == null) ? (that.onCreateNote == null) : this.onCreateNote.equals(that.onCreateNote));
      }
      return false;
    }
    ...
    public int hashCode() {
      if (!$hashCodeMemoized) {
        int h = 1;
        h *= 1000003;
        h ^= (onCreateNote == null) ? 0 : onCreateNote.hashCode();
        $hashCode = h;
    ...
    public static final class Mapper implements ResponseFieldMapper<Data> {
      final OnCreateNote.Mapper onCreateNoteFieldMapper = new OnCreateNote.Mapper();

      @Override
      public Data map(ResponseReader reader) {
        final OnCreateNote onCreateNote = reader.readObject($responseFields[0], new ResponseReader.ObjectReader<OnCreateNote>() {
          @Override
          public OnCreateNote read(ResponseReader reader) {
            return onCreateNoteFieldMapper.map(reader);
          }
        });
        return new Data(onCreateNote);
      }
    }
  }

  public static class OnCreateNote {
    static final ResponseField[] $responseFields = {
    ...
    public OnCreateNote(@Nonnull String __typename, @Nonnull String id, @Nonnull String title,
    ...
    public boolean equals(Object o) {
      ...
      if (o instanceof OnCreateNote) {
        OnCreateNote that = (OnCreateNote) o;
    ...
    public static final class Mapper implements ResponseFieldMapper<OnCreateNote> {
      @Override
      public OnCreateNote map(ResponseReader reader) {
        ...
        return new OnCreateNote(__typename, id, title, content, blabla, _version, _deleted, _lastChangedAt, owner);
      }
    }
  }
}
