...
public final class OnCreateDriverStatusInfoSubscription implements Subscription<OnCreateDriverStatusInfoSubscription.Data, OnCreateDriverStatusInfoSubscription.Data, Operation.Variables> {
  public static final String OPERATION_DEFINITION = "subscription OnCreateDriverStatusInfo {\n"
      + "  onCreateDriverStatusInfo {\n"
      + "    __typename\n"
      + "    userName\n"
      + "    driverStatus\n"
      + "    lastStatusChange\n"
  ...
  private static final OperationName OPERATION_NAME = new OperationName() {
    @Override
    public String name() {
      return "OnCreateDriverStatusInfo";
    }
  };

  private final Operation.Variables variables;

  public OnCreateDriverStatusInfoSubscription() {
    this.variables = Operation.EMPTY_VARIABLES;
  }

  @Override
  public String operationId() {
    return "1892e4d4913d7d117e0dd4dcc1cdd19315bde18e03253a780182573a06eb09ee";
  }
  ...
  @Override
  public OnCreateDriverStatusInfoSubscription.Data wrapData(OnCreateDriverStatusInfoSubscription.Data data) {
    return data;
  }
  ...
  @Override
  public ResponseFieldMapper<OnCreateDriverStatusInfoSubscription.Data> responseFieldMapper() {
  ...
  public static final class Builder {
    ...
    public OnCreateDriverStatusInfoSubscription build() {
      return new OnCreateDriverStatusInfoSubscription();
    }
  }

  public static class Data implements Operation.Data {
    static final ResponseField[] $responseFields = {
      ResponseField.forObject("onCreateDriverStatusInfo", "onCreateDriverStatusInfo", null, true, Collections.<ResponseField.Condition>emptyList())
    };

    final @Nullable OnCreateDriverStatusInfo onCreateDriverStatusInfo;
    ...
    public Data(@Nullable OnCreateDriverStatusInfo onCreateDriverStatusInfo) {
      this.onCreateDriverStatusInfo = onCreateDriverStatusInfo;
    }

    public @Nullable OnCreateDriverStatusInfo onCreateDriverStatusInfo() {
      return this.onCreateDriverStatusInfo;
    }
    ...
    public ResponseFieldMarshaller marshaller() {
      return new ResponseFieldMarshaller() {
        ...
        public void marshal(ResponseWriter writer) {
          writer.writeObject($responseFields[0], onCreateDriverStatusInfo != null ? onCreateDriverStatusInfo.marshaller() : null);
        }
      };
    }
    ...
    public String toString() {
      if ($toString == null) {
        $toString = "Data{"
          + "onCreateDriverStatusInfo=" + onCreateDriverStatusInfo
          + "}";
      }
      return $toString;
    }
    ...
    public boolean equals(Object o) {
      ...
      if (o instanceof Data) {
        Data that = (Data) o;
        return ((this.onCreateDriverStatusInfo == null) ? (that.onCreateDriverStatusInfo == null) : this.onCreateDriverStatusInfo.equals(that.onCreateDriverStatusInfo));
      }
      return false;
    }
    ...
    public int hashCode() {
      if (!$hashCodeMemoized) {
        int h = 1;
        h *= 1000003;
        h ^= (onCreateDriverStatusInfo == null) ? 0 : onCreateDriverStatusInfo.hashCode();
        $hashCode = h;
    ...
    public static final class Mapper implements ResponseFieldMapper<Data> {
      final OnCreateDriverStatusInfo.Mapper onCreateDriverStatusInfoFieldMapper = new OnCreateDriverStatusInfo.Mapper();

      @Override
      public Data map(ResponseReader reader) {
        final OnCreateDriverStatusInfo onCreateDriverStatusInfo = reader.readObject($responseFields[0], new ResponseReader.ObjectReader<OnCreateDriverStatusInfo>() {
          @Override
          public OnCreateDriverStatusInfo read(ResponseReader reader) {
            return onCreateDriverStatusInfoFieldMapper.map(reader);
          }
        });
        return new Data(onCreateDriverStatusInfo);
      }
    }
  }

  public static class OnCreateDriverStatusInfo {
    static final ResponseField[] $responseFields = {
    ...
    public OnCreateDriverStatusInfo(@Nonnull String __typename, @Nonnull String userName,
    ...
    public String toString() {
      if ($toString == null) {
        $toString = "OnCreateDriverStatusInfo{"
    ...
    public boolean equals(Object o) {
      ...
      if (o instanceof OnCreateDriverStatusInfo) {
        OnCreateDriverStatusInfo that = (OnCreateDriverStatusInfo) o;
    ...
    public static final class Mapper implements ResponseFieldMapper<OnCreateDriverStatusInfo> {
      @Override
      public OnCreateDriverStatusInfo map(ResponseReader reader) {
        ...
        return new OnCreateDriverStatusInfo(__typename, userName, driverStatus, lastStatusChange, latitude, longitude, _version, _deleted, _lastChangedAt);
      }
    }
  }
}
